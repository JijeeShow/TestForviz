...
function Thisweek({ date, roomid, data }) {
  ...
  const getBookingsForWeek = (datein) => {
    const startOfWeekDate = startOfWeek(datein, { weekStartsOn: 1 });
    const endOfWeekDate = endOfWeek(datein, { weekStartsOn: 1 });
